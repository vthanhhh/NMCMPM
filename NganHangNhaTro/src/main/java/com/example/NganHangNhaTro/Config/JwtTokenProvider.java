...
public class JwtTokenProvider {
    ...
    private long jwtExpirationDate = 200000000;
    ...
    public String generateToken(Authentication authentication) {
        ...
        List<String> vaitro = authentication.getAuthorities().stream()
    ...
    public String getTaiKhoan(String token){
